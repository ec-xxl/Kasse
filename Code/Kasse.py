...
widgets.playerButtonAdd.configure(image=pixel, compound="c", font=("Courier", 15), height=40)
widgets.playerButtonPay.configure(image=pixel, compound="c", font=("Courier", 15), height=40)
widgets.playerButtonRename.configure(image=pixel, compound="c", font=("Courier", 15), height=40)
